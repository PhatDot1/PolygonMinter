...
// Import ERC2981 for royalty support
...
contract Encode is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, ERC2981 {
    ...
    // Modifier to restrict minting to authorized minters
    modifier onlyMinter() {
    ...
    constructor() ERC721("Encode", "ENC") {
        // Set default royalty: 5% (500 basis points) to the deployer (owner)
        _setDefaultRoyalty(msg.sender, 500);
        // Initialize the deployer as an authorized minter
        minters[msg.sender] = true;
    }

    // Single token mint function (uses onlyMinter)
    ...
    // Batch minting function that allows minting multiple tokens at once
    ...
    // Function for the owner to set or update authorized minters
    function setMinter(address minter, bool allowed) public onlyOwner {
        minters[minter] = allowed;
    }

    // Fund management: owner can withdraw ETH from the contract
